...
18. **`cmd/orion`** — the single binary: interactive TUI **and** non-interactive CLI subcommands (the rvl-cli-parity surface + the loop-control surface used by the acceptance criteria).
